...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Navigation Links - Scrollable Row - MOBILE ONLY */}
      <div className="md:hidden px-4 pb-3">
        <div className="flex items-center gap-2 overflow-x-auto pb-1" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          <Link to="/" className="text-xs font-semibold whitespace-nowrap px-3 py-2 rounded-lg flex-shrink-0" style={{ color: isActive('/') ? '#fff' : 'var(--text-secondary)', backgroundColor: isActive('/') ? 'var(--bg-hover)' : 'var(--bg-secondary)' }}>
            Gallery
          </Link>
          <Link to="/saved" className="text-xs font-semibold whitespace-nowrap flex items-center gap-1.5 px-3 py-2 rounded-lg flex-shrink-0" style={{ color: isActive('/saved') ? 'var(--accent-red)' : 'var(--text-secondary)', backgroundColor: isActive('/saved') ? 'rgba(239, 68, 68, 0.1)' : 'var(--bg-secondary)' }}>
            <Heart size={12} /> Saved
          </Link>
          <Link to="/collections" className="text-xs font-semibold whitespace-nowrap flex items-center gap-1.5 px-3 py-2 rounded-lg flex-shrink-0" style={{ color: isActive('/collections') ? 'var(--accent-purple)' : 'var(--text-secondary)', backgroundColor: isActive('/collections') ? 'rgba(168, 85, 247, 0.1)' : 'var(--bg-secondary)' }}>
            <Folder size={12} /> Collections
          </Link>
          <Link to="/prompt-generator" className="text-xs font-semibold whitespace-nowrap flex items-center gap-1.5 px-3 py-2 rounded-lg flex-shrink-0" style={{ color: isActive('/prompt-generator') ? 'var(--primary-400)' : 'var(--text-secondary)', backgroundColor: isActive('/prompt-generator') ? 'rgba(59, 130, 246, 0.1)' : 'var(--bg-secondary)' }}>
            <Wand2 size={12} /> Generator
          </Link>
          <Link to="/prompt-enhancer" className="text-xs font-semibold whitespace-nowrap flex items-center gap-1.5 px-3 py-2 rounded-lg flex-shrink-0" style={{ color: isActive('/prompt-enhancer') ? '#ec4899' : 'var(--text-secondary)', backgroundColor: isActive('/prompt-enhancer') ? 'rgba(236, 72, 153, 0.1)' : 'var(--bg-secondary)' }}>
            <RefreshCw size={12} /> Enhancer
          </Link>
          <Link to="/negative-prompt" className="text-xs font-semibold whitespace-nowrap flex items-center gap-1.5 px-3 py-2 rounded-lg flex-shrink-0" style={{ color: isActive('/negative-prompt') ? '#ef4444' : 'var(--text-secondary)', backgroundColor: isActive('/negative-prompt') ? 'rgba(239, 68, 68, 0.1)' : 'var(--bg-secondary)' }}>
            <ShieldAlert size={12} /> Negative Pro
          </Link>
          <Link to="/ai-tools" className="text-xs font-semibold whitespace-nowrap flex items-center gap-1.5 px-3 py-2 rounded-lg flex-shrink-0" style={{ color: isActive('/ai-tools') ? 'var(--accent-yellow)' : 'var(--text-secondary)', backgroundColor: isActive('/ai-tools') ? 'rgba(245, 158, 11, 0.1)' : 'var(--bg-secondary)' }}>
            <Zap size={12} /> AI Tools
          </Link>
          <Link to="/blog" className="text-xs font-semibold whitespace-nowrap flex items-center gap-1.5 px-3 py-2 rounded-lg flex-shrink-0" style={{ color: isActive('/blog') ? 'var(--accent-green)' : 'var(--text-secondary)', backgroundColor: isActive('/blog') ? 'rgba(16, 185, 129, 0.1)' : 'var(--bg-secondary)' }}>
